...
This page groups project evidence by purpose. Historical records are retained
for provenance and decision review; current behavior is defined by the
...
- [Batch Notes](batches/)
- [Batch Lifecycle And Canonical Boundary](../batches/README.md)
...
- [Smart Router And Claude Skills Closure](smart-router-claude-skills-closure-report.md)
- [Phase 001 Closure](phase-001-closure-report.md)
- [Phase 002 Scenario Router Closure](phase-002-scenario-router-closure-report.md)
- [Audit Hardening Closure](audit-hardening-closure-report.md)
- [Delivery Readiness](delivery-readiness-report.md)

## Publications

- [One Trusted Skill Router Launch Article](blog-one-trusted-skill-router-2026-07-10.md)
