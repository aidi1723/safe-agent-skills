...
| `bash scripts/verify.sh` | 0 | 321 tests passed; schemas, maintenance, v1 eval, v2 eval, contract gate, invariant stage/edge and overlap-policy acceptance, and smoke routes passed |
