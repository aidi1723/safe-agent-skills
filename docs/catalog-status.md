...
The current public-safe catalog contains 60 sanitized skills across all
top-level taxonomy categories, including 18 community project reference skills
...
- `batch-007-community-depth`: additional popular community skills with clear licenses
- `batch-008-domain-depth`: deeper skills for design, code, security, and office
- `batch-009-connectors`: connector-aware skills after host adapter verification
