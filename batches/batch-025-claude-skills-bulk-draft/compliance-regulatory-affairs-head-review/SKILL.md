---
name: compliance-regulatory-affairs-head-review
description: Use when reviewing regulatory affairs head workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Regulatory Affairs Head Review

## When To Use

Use this draft when reviewing the `regulatory-affairs-head` metadata-only
...
- upstream candidate: `regulatory-affairs-head`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/regulatory-affairs-head`
