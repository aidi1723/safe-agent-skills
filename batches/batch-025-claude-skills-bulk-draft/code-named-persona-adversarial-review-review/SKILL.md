---
name: code-named-persona-adversarial-review-review
description: Use when reviewing named persona adversarial review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Named Persona Adversarial Review Review

## When To Use

Use this draft when reviewing the `named-persona-adversarial-review` metadata-only
...
- upstream candidate: `named-persona-adversarial-review`
- source domain: `engineering-team`
- source path: `engineering-team/skills/named-persona-adversarial-review`
