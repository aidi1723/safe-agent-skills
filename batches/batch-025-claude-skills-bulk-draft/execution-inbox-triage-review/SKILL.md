---
name: execution-inbox-triage-review
description: Use when reviewing inbox triage workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `inbox-triage` metadata-only
...
- upstream candidate: `inbox-triage`
- source domain: `productivity`
- source path: `productivity/email/skills/inbox-triage`
- mapped category: `execution`
- score: `37`
- priority: `P3`
