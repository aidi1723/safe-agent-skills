---
name: compliance-fda-qsr-audit-prep-review
description: Use when reviewing fda qsr audit prep workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Fda Qsr Audit Prep Review

## When To Use

Use this draft when reviewing the `fda-qsr-audit-prep` metadata-only
...
- upstream candidate: `fda-qsr-audit-prep`
- source domain: `compliance-os`
- source path: `compliance-os/skills/fda-qsr-audit-prep`
