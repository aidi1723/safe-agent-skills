---
name: compliance-aims-audit-review
description: Use when reviewing aims audit workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `aims-audit` metadata-only
...
- upstream candidate: `aims-audit`
- source domain: `compliance-os`
- source path: `compliance-os/skills/aims-audit`
