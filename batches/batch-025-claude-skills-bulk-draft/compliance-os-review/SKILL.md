---
name: compliance-os-review
description: Use when reviewing compliance os workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Compliance Os Review

## When To Use

Use this draft when reviewing the `compliance-os` metadata-only
...
- upstream candidate: `compliance-os`
- source domain: `compliance-os`
- source path: `compliance-os/skills/compliance-os`
