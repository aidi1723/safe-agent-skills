---
name: engineering-browser-automation-review
description: Use when reviewing browser automation workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `browser-automation` metadata-only
...
- upstream candidate: `browser-automation`
- source domain: `engineering`
- source path: `engineering/skills/browser-automation`
