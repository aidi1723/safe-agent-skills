---
name: business-post-mortem-review
description: Use when reviewing post mortem workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `post-mortem` metadata-only
...
- upstream candidate: `post-mortem`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/post-mortem`
