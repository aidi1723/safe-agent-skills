...
description: Use when reviewing compliance readiness workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `compliance-readiness` metadata-only
...
- upstream candidate: `compliance-readiness`
- source domain: `compliance-os`
- source path: `compliance-os/skills/compliance-readiness`
