---
name: engineering-spec-driven-workflow-review
description: Use when reviewing spec driven workflow workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Spec Driven Workflow Review

## When To Use

Use this draft when reviewing the `spec-driven-workflow` metadata-only
...
- upstream candidate: `spec-driven-workflow`
- source domain: `engineering`
- source path: `engineering/skills/spec-driven-workflow`
