---
name: business-general-counsel-advisor-review
description: Use when reviewing general counsel advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# General Counsel Advisor Review

## When To Use

Use this draft when reviewing the `general-counsel-advisor` metadata-only
...
- upstream candidate: `general-counsel-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/general-counsel-advisor`
