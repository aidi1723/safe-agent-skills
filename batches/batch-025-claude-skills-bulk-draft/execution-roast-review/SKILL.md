---
name: execution-roast-review
description: Use when reviewing roast workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `roast` metadata-only
...
- upstream candidate: `roast`
- source domain: `productivity`
- source path: `productivity/roast/skills/roast`
