---
name: execution-capture-review
description: Use when reviewing capture workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `capture` metadata-only
...
- upstream candidate: `capture`
- source domain: `productivity`
- source path: `productivity/capture/skills/capture`
