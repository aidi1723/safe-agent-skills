---
name: compliance-quality-documentation-manager-review
description: Use when reviewing quality documentation manager workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Quality Documentation Manager Review

## When To Use

Use this draft when reviewing the `quality-documentation-manager` metadata-only
...
- upstream candidate: `quality-documentation-manager`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/quality-documentation-manager`
