---
name: compliance-quality-manager-qms-iso13485-review
description: Use when reviewing quality manager qms iso13485 workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Quality Manager Qms Iso13485 Review

## When To Use

Use this draft when reviewing the `quality-manager-qms-iso13485` metadata-only
...
- upstream candidate: `quality-manager-qms-iso13485`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/quality-manager-qms-iso13485`
