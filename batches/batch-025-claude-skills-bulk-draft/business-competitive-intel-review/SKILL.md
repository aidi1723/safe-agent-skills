---
name: business-competitive-intel-review
description: Use when reviewing competitive intel workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `competitive-intel` metadata-only
...
- upstream candidate: `competitive-intel`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/competitive-intel`
