---
name: business-cto-advisor-review
description: Use when reviewing cto advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cto-advisor` metadata-only
...
- upstream candidate: `cto-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/cto-advisor`
