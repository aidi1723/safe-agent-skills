---
name: compliance-soc2-compliance-review
description: Use when reviewing soc2 compliance workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `soc2-compliance` metadata-only
...
- upstream candidate: `soc2-compliance`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/soc2-compliance`
