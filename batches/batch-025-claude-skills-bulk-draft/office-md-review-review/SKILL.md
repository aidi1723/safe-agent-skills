---
name: office-md-review-review
description: Use when reviewing md review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `md-review` metadata-only
...
- upstream candidate: `md-review`
- source domain: `markdown-html`
- source path: `markdown-html/skills/md-review`
