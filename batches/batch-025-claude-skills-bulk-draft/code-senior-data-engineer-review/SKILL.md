---
name: code-senior-data-engineer-review
description: Use when reviewing senior data engineer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Senior Data Engineer Review

## When To Use

Use this draft when reviewing the `senior-data-engineer` metadata-only
...
- upstream candidate: `senior-data-engineer`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-data-engineer`
