---
name: compliance-risk-management-specialist-review
description: Use when reviewing risk management specialist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Risk Management Specialist Review

## When To Use

Use this draft when reviewing the `risk-management-specialist` metadata-only
...
- upstream candidate: `risk-management-specialist`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/risk-management-specialist`
