---
name: engineering-skill-security-auditor-review
description: Use when reviewing skill security auditor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `skill-security-auditor` metadata-only
...
- upstream candidate: `skill-security-auditor`
- source domain: `engineering`
- source path: `engineering/skills/skill-security-auditor`
