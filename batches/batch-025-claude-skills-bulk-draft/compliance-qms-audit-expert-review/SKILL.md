---
name: compliance-qms-audit-expert-review
description: Use when reviewing qms audit expert workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Qms Audit Expert Review

## When To Use

Use this draft when reviewing the `qms-audit-expert` metadata-only
...
- upstream candidate: `qms-audit-expert`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/qms-audit-expert`
