---
name: business-boardroom-review
description: Use when reviewing boardroom workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `boardroom` metadata-only
...
- upstream candidate: `boardroom`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/boardroom`
