---
name: office-design-system-review
description: Use when reviewing design system workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `design-system` metadata-only
...
- upstream candidate: `design-system`
- source domain: `markdown-html`
- source path: `markdown-html/skills/design-system`
