---
name: compliance-agent-decision-receipts-review
description: Use when reviewing agent decision receipts workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Agent Decision Receipts Review

## When To Use

Use this draft when reviewing the `agent-decision-receipts` metadata-only
...
- upstream candidate: `agent-decision-receipts`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/agent-decision-receipts`
