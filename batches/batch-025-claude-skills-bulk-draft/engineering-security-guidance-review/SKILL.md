---
name: engineering-security-guidance-review
description: Use when reviewing security guidance workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `security-guidance` metadata-only
...
- upstream candidate: `security-guidance`
- source domain: `engineering`
- source path: `engineering/security-guidance/skills/security-guidance`
