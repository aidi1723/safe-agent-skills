---
name: content-landing-review
description: Use when reviewing landing workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `landing` metadata-only
...
- upstream candidate: `landing`
- source domain: `marketing`
- source path: `marketing/landing/skills/landing`
