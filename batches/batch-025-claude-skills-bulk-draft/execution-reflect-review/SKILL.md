---
name: execution-reflect-review
description: Use when reviewing reflect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `reflect` metadata-only
...
- upstream candidate: `reflect`
- source domain: `productivity`
- source path: `productivity/reflect/skills/reflect`
