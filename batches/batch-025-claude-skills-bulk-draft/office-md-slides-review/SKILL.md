---
name: office-md-slides-review
description: Use when reviewing md slides workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `md-slides` metadata-only
...
- upstream candidate: `md-slides`
- source domain: `markdown-html`
- source path: `markdown-html/skills/md-slides`
