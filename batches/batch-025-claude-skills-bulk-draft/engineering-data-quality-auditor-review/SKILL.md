---
name: engineering-data-quality-auditor-review
description: Use when reviewing data quality auditor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `data-quality-auditor` metadata-only
...
- upstream candidate: `data-quality-auditor`
- source domain: `engineering`
- source path: `engineering/data-quality-auditor/skills/data-quality-auditor`
