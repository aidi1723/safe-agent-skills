---
name: office-markdown-html-orchestrator-review
description: Use when reviewing markdown html orchestrator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Markdown Html Orchestrator Review

## When To Use

Use this draft when reviewing the `markdown-html-orchestrator` metadata-only
...
- upstream candidate: `markdown-html-orchestrator`
- source domain: `markdown-html`
- source path: `markdown-html/skills/markdown-html-orchestrator`
- mapped category: `office`
- score: `37`
- priority: `P3`
