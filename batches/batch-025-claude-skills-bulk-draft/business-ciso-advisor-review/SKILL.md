---
name: business-ciso-advisor-review
description: Use when reviewing ciso advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ciso-advisor` metadata-only
...
- upstream candidate: `ciso-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/ciso-advisor`
