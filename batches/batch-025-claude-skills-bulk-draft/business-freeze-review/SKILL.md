---
name: business-freeze-review
description: Use when reviewing freeze workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `freeze` metadata-only
...
- source path: `c-level-advisor/c-level-agents/skills/freeze`
