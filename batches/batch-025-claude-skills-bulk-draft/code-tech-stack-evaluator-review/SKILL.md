---
name: code-tech-stack-evaluator-review
description: Use when reviewing tech stack evaluator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Tech Stack Evaluator Review

## When To Use

Use this draft when reviewing the `tech-stack-evaluator` metadata-only
...
- upstream candidate: `tech-stack-evaluator`
- source domain: `engineering-team`
- source path: `engineering-team/skills/tech-stack-evaluator`
