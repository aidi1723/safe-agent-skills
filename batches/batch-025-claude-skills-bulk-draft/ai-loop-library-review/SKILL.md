---
name: ai-loop-library-review
description: Use when reviewing loop library workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `loop-library` metadata-only
...
- upstream candidate: `loop-library`
- source domain: `loop-library`
- source path: `loop-library`
- mapped category: `ai`
- score: `25`
- priority: `P3`
