---
name: compliance-isms-audit-expert-review
description: Use when reviewing isms audit expert workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Isms Audit Expert Review

## When To Use

Use this draft when reviewing the `isms-audit-expert` metadata-only
...
- upstream candidate: `isms-audit-expert`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/isms-audit-expert`
