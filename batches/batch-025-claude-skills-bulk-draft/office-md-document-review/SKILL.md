---
name: office-md-document-review
description: Use when reviewing md document workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `md-document` metadata-only
...
- upstream candidate: `md-document`
- source domain: `markdown-html`
- source path: `markdown-html/skills/md-document`
