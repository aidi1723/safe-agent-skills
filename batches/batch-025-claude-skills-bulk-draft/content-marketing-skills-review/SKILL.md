---
name: content-marketing-skills-review
description: Use when reviewing marketing skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Marketing Skills Review

## When To Use

Use this draft when reviewing the `marketing-skills` metadata-only
...
- upstream candidate: `marketing-skills`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-skills`
