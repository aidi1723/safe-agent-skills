---
name: business-vpe-advisor-review
description: Use when reviewing vpe advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `vpe-advisor` metadata-only
...
- upstream candidate: `vpe-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/vpe-advisor`
