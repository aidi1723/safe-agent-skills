---
name: business-ma-playbook-review
description: Use when reviewing ma playbook workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ma-playbook` metadata-only
...
- upstream candidate: `ma-playbook`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/ma-playbook`
