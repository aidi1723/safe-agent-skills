---
name: business-cro-review-review
description: Use when reviewing cro review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cro-review` metadata-only
...
- upstream candidate: `cro-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cro-review`
