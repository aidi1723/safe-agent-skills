---
name: compliance-soc2-audit-prep-review
description: Use when reviewing soc2 audit prep workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Soc2 Audit Prep Review

## When To Use

Use this draft when reviewing the `soc2-audit-prep` metadata-only
...
- upstream candidate: `soc2-audit-prep`
- source domain: `compliance-os`
- source path: `compliance-os/skills/soc2-audit-prep`
