---
name: compliance-ai-act-readiness-review
description: Use when reviewing ai act readiness workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ai-act-readiness` metadata-only
...
- upstream candidate: `ai-act-readiness`
- source domain: `compliance-os`
- source path: `compliance-os/skills/ai-act-readiness`
