---
name: compliance-quality-manager-qmr-review
description: Use when reviewing quality manager qmr workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Quality Manager Qmr Review

## When To Use

Use this draft when reviewing the `quality-manager-qmr` metadata-only
...
- upstream candidate: `quality-manager-qmr`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/quality-manager-qmr`
