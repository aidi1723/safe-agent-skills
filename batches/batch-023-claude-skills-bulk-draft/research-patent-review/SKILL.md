---
name: research-patent-review
description: Use when reviewing patent workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `patent` metadata-only
...
- upstream candidate: `patent`
- source domain: `research`
- source path: `research/patent/skills/patent`
