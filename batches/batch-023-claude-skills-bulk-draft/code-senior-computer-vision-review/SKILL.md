---
name: code-senior-computer-vision-review
description: Use when reviewing senior computer vision workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Senior Computer Vision Review

## When To Use

Use this draft when reviewing the `senior-computer-vision` metadata-only
...
- upstream candidate: `senior-computer-vision`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-computer-vision`
