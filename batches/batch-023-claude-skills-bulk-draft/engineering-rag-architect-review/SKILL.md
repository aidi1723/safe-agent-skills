---
name: engineering-rag-architect-review
description: Use when reviewing rag architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Rag Architect Review

## When To Use

Use this draft when reviewing the `rag-architect` metadata-only
...
- upstream candidate: `rag-architect`
- source domain: `engineering`
- source path: `engineering/skills/rag-architect`
