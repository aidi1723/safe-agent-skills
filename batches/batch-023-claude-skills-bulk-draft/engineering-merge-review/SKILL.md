---
name: engineering-merge-review
description: Use when reviewing merge workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `merge` metadata-only
...
- upstream candidate: `merge`
- source domain: `engineering`
- source path: `engineering/agenthub/skills/merge`
