...
description: Use when reviewing content strategy workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `content-strategy` metadata-only
...
- upstream candidate: `content-strategy`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/content-strategy`
