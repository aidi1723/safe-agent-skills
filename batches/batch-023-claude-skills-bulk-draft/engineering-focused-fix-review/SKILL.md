---
name: engineering-focused-fix-review
description: Use when reviewing focused fix workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `focused-fix` metadata-only
...
- upstream candidate: `focused-fix`
- source domain: `engineering`
- source path: `engineering/skills/focused-fix`
