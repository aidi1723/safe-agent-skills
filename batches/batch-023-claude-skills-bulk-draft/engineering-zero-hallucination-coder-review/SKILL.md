---
name: engineering-zero-hallucination-coder-review
description: Use when reviewing zero hallucination coder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Zero Hallucination Coder Review

## When To Use

Use this draft when reviewing the `zero-hallucination-coder` metadata-only
...
- upstream candidate: `zero-hallucination-coder`
- source domain: `engineering`
- source path: `engineering/zero-hallucination-coder/skills/zero-hallucination-coder`
