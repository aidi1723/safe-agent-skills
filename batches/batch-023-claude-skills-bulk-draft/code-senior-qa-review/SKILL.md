---
name: code-senior-qa-review
description: Use when reviewing senior qa workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-qa` metadata-only
...
- upstream candidate: `senior-qa`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-qa`
