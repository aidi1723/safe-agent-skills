---
name: code-snowflake-development-review
description: Use when reviewing snowflake development workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Snowflake Development Review

## When To Use

Use this draft when reviewing the `snowflake-development` metadata-only
...
- upstream candidate: `snowflake-development`
- source domain: `engineering-team`
- source path: `engineering-team/snowflake-development/skills/snowflake-development`
