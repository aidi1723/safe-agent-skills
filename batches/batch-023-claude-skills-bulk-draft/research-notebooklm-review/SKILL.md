---
name: research-notebooklm-review
description: Use when reviewing notebooklm workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `notebooklm` metadata-only
...
- upstream candidate: `notebooklm`
- source domain: `research`
- source path: `research/notebooklm/skills/notebooklm`
