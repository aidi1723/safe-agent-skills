---
name: engineering-migration-architect-review
description: Use when reviewing migration architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Migration Architect Review

## When To Use

Use this draft when reviewing the `migration-architect` metadata-only
...
- upstream candidate: `migration-architect`
- source domain: `engineering`
- source path: `engineering/skills/migration-architect`
