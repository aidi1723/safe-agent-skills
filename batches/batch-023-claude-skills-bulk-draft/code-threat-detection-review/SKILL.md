---
name: code-threat-detection-review
description: Use when reviewing threat detection workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `threat-detection` metadata-only
...
- upstream candidate: `threat-detection`
- source domain: `engineering-team`
- source path: `engineering-team/skills/threat-detection`
