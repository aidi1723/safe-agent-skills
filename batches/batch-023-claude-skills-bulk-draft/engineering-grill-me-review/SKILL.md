---
name: engineering-grill-me-review
description: Use when reviewing grill me workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `grill-me` metadata-only
...
- upstream candidate: `grill-me`
- source domain: `engineering`
- source path: `engineering/grill-me/skills/grill-me`
