---
name: code-fix-review
description: Use when reviewing fix workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `fix` metadata-only
...
- source path: `engineering-team/playwright-pro/skills/fix`
