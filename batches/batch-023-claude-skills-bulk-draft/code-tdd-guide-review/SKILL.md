---
name: code-tdd-guide-review
description: Use when reviewing tdd guide workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `tdd-guide` metadata-only
...
- upstream candidate: `tdd-guide`
- source domain: `engineering-team`
- source path: `engineering-team/skills/tdd-guide`
