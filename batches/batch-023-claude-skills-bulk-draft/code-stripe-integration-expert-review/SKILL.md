---
name: code-stripe-integration-expert-review
description: Use when reviewing stripe integration expert workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Stripe Integration Expert Review

## When To Use

Use this draft when reviewing the `stripe-integration-expert` metadata-only
...
- upstream candidate: `stripe-integration-expert`
- source domain: `engineering-team`
- source path: `engineering-team/skills/stripe-integration-expert`
