---
name: execution-inbox-setup-review
description: Use when reviewing inbox setup workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `inbox-setup` metadata-only
...
- upstream candidate: `inbox-setup`
- source domain: `productivity`
- source path: `productivity/email/skills/inbox-setup`
