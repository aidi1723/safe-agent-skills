---
name: engineering-git-worktree-manager-review
description: Use when reviewing git worktree manager workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Git Worktree Manager Review

## When To Use

Use this draft when reviewing the `git-worktree-manager` metadata-only
...
- upstream candidate: `git-worktree-manager`
- source domain: `engineering`
- source path: `engineering/skills/git-worktree-manager`
