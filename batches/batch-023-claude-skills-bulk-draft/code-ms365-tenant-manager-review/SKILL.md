---
name: code-ms365-tenant-manager-review
description: Use when reviewing ms365 tenant manager workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Ms365 Tenant Manager Review

## When To Use

Use this draft when reviewing the `ms365-tenant-manager` metadata-only
...
- upstream candidate: `ms365-tenant-manager`
- source domain: `engineering-team`
- source path: `engineering-team/skills/ms365-tenant-manager`
