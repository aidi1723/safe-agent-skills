---
name: engineering-kubernetes-operator-review
description: Use when reviewing kubernetes operator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Kubernetes Operator Review

## When To Use

Use this draft when reviewing the `kubernetes-operator` metadata-only
...
- upstream candidate: `kubernetes-operator`
- source domain: `engineering`
- source path: `engineering/skills/kubernetes-operator`
