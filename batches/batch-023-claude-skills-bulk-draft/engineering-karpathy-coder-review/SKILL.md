---
name: engineering-karpathy-coder-review
description: Use when reviewing karpathy coder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Karpathy Coder Review

## When To Use

Use this draft when reviewing the `karpathy-coder` metadata-only
...
- upstream candidate: `karpathy-coder`
- source domain: `engineering`
- source path: `engineering/karpathy-coder/skills/karpathy-coder`
