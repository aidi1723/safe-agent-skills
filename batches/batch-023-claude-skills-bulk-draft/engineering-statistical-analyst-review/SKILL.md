---
name: engineering-statistical-analyst-review
description: Use when reviewing statistical analyst workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `statistical-analyst` metadata-only
...
- upstream candidate: `statistical-analyst`
- source domain: `engineering`
- source path: `engineering/statistical-analyst/skills/statistical-analyst`
