---
name: business-product-skills-review
description: Use when reviewing product skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `product-skills` metadata-only
...
- upstream candidate: `product-skills`
- source domain: `product-team`
- source path: `product-team/skills/product-skills`
