---
name: engineering-universal-scraping-architect-review
description: Use when reviewing universal scraping architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Universal Scraping Architect Review

## When To Use

Use this draft when reviewing the `universal-scraping-architect` metadata-only
...
- upstream candidate: `universal-scraping-architect`
- source domain: `engineering`
- source path: `engineering/universal-scraping-architect/skills/universal-scraping-architect`
