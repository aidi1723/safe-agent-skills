---
name: code-promote-review
description: Use when reviewing promote workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `promote` metadata-only
...
- upstream candidate: `promote`
- source domain: `engineering-team`
- source path: `engineering-team/self-improving-agent/skills/promote`
