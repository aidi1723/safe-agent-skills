---
name: compliance-eu-ai-act-specialist-review
description: Use when reviewing eu ai act specialist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Eu Ai Act Specialist Review

## When To Use

Use this draft when reviewing the `eu-ai-act-specialist` metadata-only
...
- upstream candidate: `eu-ai-act-specialist`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/eu-ai-act-specialist`
