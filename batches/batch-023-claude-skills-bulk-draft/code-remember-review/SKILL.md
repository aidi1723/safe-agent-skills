---
name: code-remember-review
description: Use when reviewing remember workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `remember` metadata-only
...
- upstream candidate: `remember`
- source domain: `engineering-team`
- source path: `engineering-team/self-improving-agent/skills/remember`
