---
name: engineering-feature-flags-architect-review
description: Use when reviewing feature flags architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Feature Flags Architect Review

## When To Use

Use this draft when reviewing the `feature-flags-architect` metadata-only
...
- upstream candidate: `feature-flags-architect`
- source domain: `engineering`
- source path: `engineering/skills/feature-flags-architect`
