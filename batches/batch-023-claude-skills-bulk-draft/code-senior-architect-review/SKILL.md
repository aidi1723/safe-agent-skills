---
name: code-senior-architect-review
description: Use when reviewing senior architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-architect` metadata-only
...
- upstream candidate: `senior-architect`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-architect`
