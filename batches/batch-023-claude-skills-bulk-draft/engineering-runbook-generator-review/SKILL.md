---
name: engineering-runbook-generator-review
description: Use when reviewing runbook generator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Runbook Generator Review

## When To Use

Use this draft when reviewing the `runbook-generator` metadata-only
...
- upstream candidate: `runbook-generator`
- source domain: `engineering`
- source path: `engineering/skills/runbook-generator`
