---
name: code-senior-backend-review
description: Use when reviewing senior backend workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-backend` metadata-only
...
- upstream candidate: `senior-backend`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-backend`
