---
name: research-litreview-review
description: Use when reviewing litreview workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `litreview` metadata-only
...
- upstream candidate: `litreview`
- source domain: `research`
- source path: `research/litreview/skills/litreview`
