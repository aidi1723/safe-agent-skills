---
name: code-incident-response-review
description: Use when reviewing incident response workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `incident-response` metadata-only
...
- upstream candidate: `incident-response`
- source domain: `engineering-team`
- source path: `engineering-team/skills/incident-response`
