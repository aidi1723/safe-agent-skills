---
name: research-syllabus-review
description: Use when reviewing syllabus workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `syllabus` metadata-only
...
- upstream candidate: `syllabus`
- source domain: `research`
- source path: `research/syllabus/skills/syllabus`
