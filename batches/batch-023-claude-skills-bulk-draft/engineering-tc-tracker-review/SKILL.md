---
name: engineering-tc-tracker-review
description: Use when reviewing tc tracker workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `tc-tracker` metadata-only
...
- upstream candidate: `tc-tracker`
- source domain: `engineering`
- source path: `engineering/skills/tc-tracker`
