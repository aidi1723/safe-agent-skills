---
name: engineering-agent-workflow-designer-review
description: Use when reviewing agent workflow designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Agent Workflow Designer Review

## When To Use

Use this draft when reviewing the `agent-workflow-designer` metadata-only
...
- upstream candidate: `agent-workflow-designer`
- source domain: `engineering`
- source path: `engineering/skills/agent-workflow-designer`
