---
name: engineering-monorepo-navigator-review
description: Use when reviewing monorepo navigator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Monorepo Navigator Review

## When To Use

Use this draft when reviewing the `monorepo-navigator` metadata-only
...
- upstream candidate: `monorepo-navigator`
- source domain: `engineering`
- source path: `engineering/skills/monorepo-navigator`
