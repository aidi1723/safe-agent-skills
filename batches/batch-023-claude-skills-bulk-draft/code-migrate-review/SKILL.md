---
name: code-migrate-review
description: Use when reviewing migrate workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `migrate` metadata-only
...
- upstream candidate: `migrate`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/migrate`
