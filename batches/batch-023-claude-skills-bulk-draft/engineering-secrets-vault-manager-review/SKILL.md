---
name: engineering-secrets-vault-manager-review
description: Use when reviewing secrets vault manager workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Secrets Vault Manager Review

## When To Use

Use this draft when reviewing the `secrets-vault-manager` metadata-only
...
- upstream candidate: `secrets-vault-manager`
- source domain: `engineering`
- source path: `engineering/skills/secrets-vault-manager`
