---
name: code-testrail-review
description: Use when reviewing testrail workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `testrail` metadata-only
...
- upstream candidate: `testrail`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/testrail`
