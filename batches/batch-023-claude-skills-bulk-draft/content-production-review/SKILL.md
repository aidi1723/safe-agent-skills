---
name: content-production-review
description: Use when reviewing content production workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `content-production` metadata-only
...
- upstream candidate: `content-production`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/content-production`
