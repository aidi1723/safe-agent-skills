---
name: engineering-spawn-review
description: Use when reviewing spawn workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `spawn` metadata-only
...
- upstream candidate: `spawn`
- source domain: `engineering`
- source path: `engineering/agenthub/skills/spawn`
