---
name: code-incident-commander-review
description: Use when reviewing incident commander workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `incident-commander` metadata-only
...
- upstream candidate: `incident-commander`
- source domain: `engineering-team`
- source path: `engineering-team/skills/incident-commander`
