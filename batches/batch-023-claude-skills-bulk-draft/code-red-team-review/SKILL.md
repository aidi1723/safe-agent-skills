---
name: code-red-team-review
description: Use when reviewing red team workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `red-team` metadata-only
...
- upstream candidate: `red-team`
- source domain: `engineering-team`
- source path: `engineering-team/skills/red-team`
