---
name: research-dossier-review
description: Use when reviewing dossier workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `dossier` metadata-only
...
- upstream candidate: `dossier`
- source domain: `research`
- source path: `research/dossier/skills/dossier`
