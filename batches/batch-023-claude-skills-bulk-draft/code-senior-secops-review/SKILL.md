---
name: code-senior-secops-review
description: Use when reviewing senior secops workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Senior Secops Review

## When To Use

Use this draft when reviewing the `senior-secops` metadata-only
...
- upstream candidate: `senior-secops`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-secops`
