---
name: code-senior-devops-review
description: Use when reviewing senior devops workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Senior Devops Review

## When To Use

Use this draft when reviewing the `senior-devops` metadata-only
...
- upstream candidate: `senior-devops`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-devops`
