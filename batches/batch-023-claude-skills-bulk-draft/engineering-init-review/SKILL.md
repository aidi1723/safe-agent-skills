---
name: engineering-init-review
description: Use when reviewing init workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `init` metadata-only
...
- upstream candidate: `init`
- source domain: `engineering`
- source path: `engineering/agenthub/skills/init`
