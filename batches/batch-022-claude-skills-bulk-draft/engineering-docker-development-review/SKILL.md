---
name: engineering-docker-development-review
description: Use when reviewing docker development workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `docker-development` metadata-only
...
- upstream candidate: `docker-development`
- source domain: `engineering`
- source path: `engineering/docker-development/skills/docker-development`
