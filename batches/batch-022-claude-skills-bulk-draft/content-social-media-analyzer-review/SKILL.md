---
name: content-social-media-analyzer-review
description: Use when reviewing social media analyzer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Social Media Analyzer Review

## When To Use

Use this draft when reviewing the `social-media-analyzer` metadata-only
...
- upstream candidate: `social-media-analyzer`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/social-media-analyzer`
