---
name: engineering-changelog-generator-review
description: Use when reviewing changelog generator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Changelog Generator Review

## When To Use

Use this draft when reviewing the `changelog-generator` metadata-only
...
- upstream candidate: `changelog-generator`
- source domain: `engineering`
- source path: `engineering/skills/changelog-generator`
