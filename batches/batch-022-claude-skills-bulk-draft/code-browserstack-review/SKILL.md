---
name: code-browserstack-review
description: Use when reviewing browserstack workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `browserstack` metadata-only
...
- upstream candidate: `browserstack`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/browserstack`
