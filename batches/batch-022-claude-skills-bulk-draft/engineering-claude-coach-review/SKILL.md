---
name: engineering-claude-coach-review
description: Use when reviewing claude coach workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `claude-coach` metadata-only
...
- upstream candidate: `claude-coach`
- source domain: `engineering`
- source path: `engineering/claude-coach/skills/claude-coach`
