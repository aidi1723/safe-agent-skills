---
name: engineering-caveman-review
description: Use when reviewing caveman workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `caveman` metadata-only
...
- upstream candidate: `caveman`
- source domain: `engineering`
- source path: `engineering/caveman/skills/caveman`
