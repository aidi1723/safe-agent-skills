---
name: content-youtube-full-review
description: Use when reviewing youtube full workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `youtube-full` metadata-only
...
- upstream candidate: `youtube-full`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/youtube-full`
