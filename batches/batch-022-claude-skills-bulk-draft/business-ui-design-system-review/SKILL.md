---
name: business-ui-design-system-review
description: Use when reviewing ui design system workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ui-design-system` metadata-only
...
- upstream candidate: `ui-design-system`
- source domain: `product-team`
- source path: `product-team/skills/ui-design-system`
