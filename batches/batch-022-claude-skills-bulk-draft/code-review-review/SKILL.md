...
description: Use when reviewing review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `review` metadata-only
...
- source path: `engineering-team/self-improving-agent/skills/review`
