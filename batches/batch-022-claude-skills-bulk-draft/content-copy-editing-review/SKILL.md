---
name: content-copy-editing-review
description: Use when reviewing copy editing workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `copy-editing` metadata-only
...
- upstream candidate: `copy-editing`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/copy-editing`
