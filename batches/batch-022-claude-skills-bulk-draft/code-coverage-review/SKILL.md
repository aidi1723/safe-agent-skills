---
name: code-coverage-review
description: Use when reviewing coverage workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `coverage` metadata-only
...
- upstream candidate: `coverage`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/coverage`
