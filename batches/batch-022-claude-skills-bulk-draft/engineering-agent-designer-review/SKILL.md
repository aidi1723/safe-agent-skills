---
name: engineering-agent-designer-review
description: Use when reviewing agent designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `agent-designer` metadata-only
...
- upstream candidate: `agent-designer`
- source domain: `engineering`
- source path: `engineering/skills/agent-designer`
