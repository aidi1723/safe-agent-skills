---
name: engineering-dependency-auditor-review
description: Use when reviewing dependency auditor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `dependency-auditor` metadata-only
...
- upstream candidate: `dependency-auditor`
