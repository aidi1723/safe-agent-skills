---
name: content-ab-test-setup-review
description: Use when reviewing ab test setup workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ab-test-setup` metadata-only
...
- upstream candidate: `ab-test-setup`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/ab-test-setup`
