---
name: content-marketing-psychology-review
description: Use when reviewing marketing psychology workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Marketing Psychology Review

## When To Use

Use this draft when reviewing the `marketing-psychology` metadata-only
...
- upstream candidate: `marketing-psychology`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-psychology`
