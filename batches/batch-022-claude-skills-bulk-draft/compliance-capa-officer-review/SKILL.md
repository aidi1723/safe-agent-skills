---
name: compliance-capa-officer-review
description: Use when reviewing capa officer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `capa-officer` metadata-only
...
- upstream candidate: `capa-officer`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/capa-officer`
