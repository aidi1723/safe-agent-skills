---
name: content-form-cro-review
description: Use when reviewing form cro workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `form-cro` metadata-only
...
- upstream candidate: `form-cro`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/form-cro`
