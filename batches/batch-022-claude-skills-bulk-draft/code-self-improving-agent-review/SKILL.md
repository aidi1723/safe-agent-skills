---
name: code-self-improving-agent-review
description: Use when reviewing self improving agent workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `self-improving-agent` metadata-only
...
- upstream candidate: `self-improving-agent`
- source domain: `engineering-team`
- source path: `engineering-team/self-improving-agent/skills/self-improving-agent`
