---
name: content-marketing-ops-review
description: Use when reviewing marketing ops workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `marketing-ops` metadata-only
...
- upstream candidate: `marketing-ops`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-ops`
