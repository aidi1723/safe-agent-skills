---
name: content-webinar-marketing-review
description: Use when reviewing webinar marketing workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Webinar Marketing Review

## When To Use

Use this draft when reviewing the `webinar-marketing` metadata-only
...
- upstream candidate: `webinar-marketing`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/webinar-marketing`
