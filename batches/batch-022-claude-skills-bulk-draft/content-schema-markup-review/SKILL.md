---
name: content-schema-markup-review
description: Use when reviewing schema markup workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `schema-markup` metadata-only
...
- upstream candidate: `schema-markup`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/schema-markup`
