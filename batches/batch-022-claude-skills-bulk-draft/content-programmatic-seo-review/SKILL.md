---
name: content-programmatic-seo-review
description: Use when reviewing programmatic seo workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `programmatic-seo` metadata-only
...
- upstream candidate: `programmatic-seo`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/programmatic-seo`
