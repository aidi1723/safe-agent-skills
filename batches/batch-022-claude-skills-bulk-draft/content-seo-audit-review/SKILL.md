---
name: content-seo-audit-review
description: Use when reviewing seo audit workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `seo-audit` metadata-only
...
- upstream candidate: `seo-audit`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/seo-audit`
