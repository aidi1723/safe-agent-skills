---
name: engineering-database-designer-review
description: Use when reviewing database designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `database-designer` metadata-only
...
- upstream candidate: `database-designer`
- source domain: `engineering`
- source path: `engineering/skills/database-designer`
