---
name: engineering-api-test-suite-builder-review
description: Use when reviewing api test suite builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Api Test Suite Builder Review

## When To Use

Use this draft when reviewing the `api-test-suite-builder` metadata-only
...
- upstream candidate: `api-test-suite-builder`
- source domain: `engineering`
- source path: `engineering/skills/api-test-suite-builder`
