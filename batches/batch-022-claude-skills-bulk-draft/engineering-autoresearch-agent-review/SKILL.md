---
name: engineering-autoresearch-agent-review
description: Use when reviewing autoresearch agent workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Autoresearch Agent Review

## When To Use

Use this draft when reviewing the `autoresearch-agent` metadata-only
...
- upstream candidate: `autoresearch-agent`
- source domain: `engineering`
- source path: `engineering/autoresearch-agent/skills/autoresearch-agent`
