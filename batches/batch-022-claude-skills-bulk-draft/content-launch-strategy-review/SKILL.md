---
name: content-launch-strategy-review
description: Use when reviewing launch strategy workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `launch-strategy` metadata-only
...
- upstream candidate: `launch-strategy`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/launch-strategy`
