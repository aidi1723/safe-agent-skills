---
name: code-azure-cloud-architect-review
description: Use when reviewing azure cloud architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Azure Cloud Architect Review

## When To Use

Use this draft when reviewing the `azure-cloud-architect` metadata-only
...
- upstream candidate: `azure-cloud-architect`
- source domain: `engineering-team`
- source path: `engineering-team/skills/azure-cloud-architect`
