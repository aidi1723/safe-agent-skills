---
name: code-aws-solution-architect-review
description: Use when reviewing aws solution architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Aws Solution Architect Review

## When To Use

Use this draft when reviewing the `aws-solution-architect` metadata-only
...
- upstream candidate: `aws-solution-architect`
- source domain: `engineering-team`
- source path: `engineering-team/skills/aws-solution-architect`
