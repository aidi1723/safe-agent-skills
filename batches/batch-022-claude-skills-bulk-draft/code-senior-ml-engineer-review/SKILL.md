---
name: code-senior-ml-engineer-review
description: Use when reviewing senior ml engineer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-ml-engineer` metadata-only
...
- upstream candidate: `senior-ml-engineer`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-ml-engineer`
