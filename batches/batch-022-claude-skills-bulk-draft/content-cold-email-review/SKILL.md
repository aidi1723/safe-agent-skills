---
name: content-cold-email-review
description: Use when reviewing cold email workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cold-email` metadata-only
...
- upstream candidate: `cold-email`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/cold-email`
