---
name: content-local-seo-manager-review
description: Use when reviewing local seo manager workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Local Seo Manager Review

## When To Use

Use this draft when reviewing the `local-seo-manager` metadata-only
...
- upstream candidate: `local-seo-manager`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/local-seo-manager`
