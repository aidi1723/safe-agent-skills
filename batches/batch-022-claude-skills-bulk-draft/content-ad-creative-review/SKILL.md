---
name: content-ad-creative-review
description: Use when reviewing ad creative workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ad-creative` metadata-only
...
- upstream candidate: `ad-creative`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/ad-creative`
