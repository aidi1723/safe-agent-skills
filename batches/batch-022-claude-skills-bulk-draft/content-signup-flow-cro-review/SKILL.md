---
name: content-signup-flow-cro-review
description: Use when reviewing signup flow cro workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Signup Flow Cro Review

## When To Use

Use this draft when reviewing the `signup-flow-cro` metadata-only
...
- upstream candidate: `signup-flow-cro`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/signup-flow-cro`
