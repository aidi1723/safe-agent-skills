---
name: content-referral-program-review
description: Use when reviewing referral program workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `referral-program` metadata-only
...
- upstream candidate: `referral-program`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/referral-program`
