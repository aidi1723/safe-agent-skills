---
name: code-senior-frontend-review
description: Use when reviewing senior frontend workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-frontend` metadata-only
...
- upstream candidate: `senior-frontend`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-frontend`
