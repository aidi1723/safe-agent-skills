---
name: content-popup-cro-review
description: Use when reviewing popup cro workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `popup-cro` metadata-only
...
- upstream candidate: `popup-cro`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/popup-cro`
