---
name: content-brand-guidelines-review
description: Use when reviewing brand guidelines workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `brand-guidelines` metadata-only
...
- upstream candidate: `brand-guidelines`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/brand-guidelines`
