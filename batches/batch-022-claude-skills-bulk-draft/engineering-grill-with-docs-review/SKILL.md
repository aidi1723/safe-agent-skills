---
name: engineering-grill-with-docs-review
description: Use when reviewing grill with docs workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `grill-with-docs` metadata-only
...
- upstream candidate: `grill-with-docs`
- source domain: `engineering`
- source path: `engineering/grill-with-docs/skills/grill-with-docs`
