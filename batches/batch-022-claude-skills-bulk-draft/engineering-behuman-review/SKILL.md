---
name: engineering-behuman-review
description: Use when reviewing behuman workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `behuman` metadata-only
...
- upstream candidate: `behuman`
- source domain: `engineering`
- source path: `engineering/behuman/skills/behuman`
