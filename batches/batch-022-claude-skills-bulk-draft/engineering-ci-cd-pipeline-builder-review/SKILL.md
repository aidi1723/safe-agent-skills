---
name: engineering-ci-cd-pipeline-builder-review
description: Use when reviewing ci cd pipeline builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Ci Cd Pipeline Builder Review

## When To Use

Use this draft when reviewing the `ci-cd-pipeline-builder` metadata-only
...
- upstream candidate: `ci-cd-pipeline-builder`
- source domain: `engineering`
- source path: `engineering/skills/ci-cd-pipeline-builder`
