---
name: content-aeo-review
description: Use when reviewing aeo workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `aeo` metadata-only
...
- upstream candidate: `aeo`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/aeo`
