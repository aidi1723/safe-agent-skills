...
description: Use when reviewing content creator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `content-creator` metadata-only
...
- upstream candidate: `content-creator`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/content-creator`
