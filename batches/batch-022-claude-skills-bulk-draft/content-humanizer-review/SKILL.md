---
name: content-humanizer-review
description: Use when reviewing content humanizer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Content Humanizer Review

## When To Use

Use this draft when reviewing the `content-humanizer` metadata-only
...
- upstream candidate: `content-humanizer`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/content-humanizer`
