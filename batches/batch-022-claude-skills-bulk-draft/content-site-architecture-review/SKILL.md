---
name: content-site-architecture-review
description: Use when reviewing site architecture workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `site-architecture` metadata-only
...
- upstream candidate: `site-architecture`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/site-architecture`
