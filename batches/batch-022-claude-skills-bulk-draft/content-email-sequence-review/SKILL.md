---
name: content-email-sequence-review
description: Use when reviewing email sequence workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `email-sequence` metadata-only
...
- upstream candidate: `email-sequence`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/email-sequence`
