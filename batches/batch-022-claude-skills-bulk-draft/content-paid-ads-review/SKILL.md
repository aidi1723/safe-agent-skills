---
name: content-paid-ads-review
description: Use when reviewing paid ads workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `paid-ads` metadata-only
...
- upstream candidate: `paid-ads`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/paid-ads`
