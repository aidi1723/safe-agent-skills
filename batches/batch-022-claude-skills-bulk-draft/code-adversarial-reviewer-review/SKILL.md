---
name: code-adversarial-reviewer-review
description: Use when reviewing adversarial reviewer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `adversarial-reviewer` metadata-only
...
- upstream candidate: `adversarial-reviewer`
- source domain: `engineering-team`
- source path: `engineering-team/skills/adversarial-reviewer`
