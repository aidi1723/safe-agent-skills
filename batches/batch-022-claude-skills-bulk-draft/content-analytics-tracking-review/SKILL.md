---
name: content-analytics-tracking-review
description: Use when reviewing analytics tracking workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `analytics-tracking` metadata-only
...
- upstream candidate: `analytics-tracking`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/analytics-tracking`
