---
name: code-senior-prompt-engineer-review
description: Use when reviewing senior prompt engineer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
- upstream candidate: `senior-prompt-engineer`
