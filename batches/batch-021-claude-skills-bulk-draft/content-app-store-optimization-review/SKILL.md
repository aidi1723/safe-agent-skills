---
name: content-app-store-optimization-review
description: Use when reviewing app store optimization workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `app-store-optimization` metadata-only
...
- upstream candidate: `app-store-optimization`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/app-store-optimization`
