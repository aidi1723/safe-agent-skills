---
name: engineering-mcp-server-builder-review
description: Use when reviewing mcp server builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Mcp Server Builder Review

## When To Use

Use this draft when reviewing the `mcp-server-builder` metadata-only
...
- upstream candidate: `mcp-server-builder`
- source domain: `engineering`
- source path: `engineering/skills/mcp-server-builder`
