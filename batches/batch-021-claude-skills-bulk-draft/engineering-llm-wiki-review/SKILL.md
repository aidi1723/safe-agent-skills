---
name: engineering-llm-wiki-review
description: Use when reviewing llm wiki workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `llm-wiki` metadata-only
...
- upstream candidate: `llm-wiki`
- source domain: `engineering`
- source path: `engineering/llm-wiki/skills/llm-wiki`
