---
name: business-experiment-designer-review
description: Use when reviewing experiment designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Experiment Designer Review

## When To Use

Use this draft when reviewing the `experiment-designer` metadata-only
...
- upstream candidate: `experiment-designer`
- source domain: `product-team`
- source path: `product-team/skills/experiment-designer`
