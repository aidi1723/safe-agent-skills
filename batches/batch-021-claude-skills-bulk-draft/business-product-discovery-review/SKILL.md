---
name: business-product-discovery-review
description: Use when reviewing product discovery workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `product-discovery` metadata-only
...
- upstream candidate: `product-discovery`
- source domain: `product-team`
- source path: `product-team/skills/product-discovery`
