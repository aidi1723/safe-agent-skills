---
name: content-churn-prevention-review
description: Use when reviewing churn prevention workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Churn Prevention Review

## When To Use

Use this draft when reviewing the `churn-prevention` metadata-only
...
- upstream candidate: `churn-prevention`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/churn-prevention`
