---
name: business-roadmap-communicator-review
description: Use when reviewing roadmap communicator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Roadmap Communicator Review

## When To Use

Use this draft when reviewing the `roadmap-communicator` metadata-only
...
- upstream candidate: `roadmap-communicator`
- source domain: `product-team`
- source path: `product-team/skills/roadmap-communicator`
