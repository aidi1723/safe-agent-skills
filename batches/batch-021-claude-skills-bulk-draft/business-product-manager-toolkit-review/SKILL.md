---
name: business-product-manager-toolkit-review
description: Use when reviewing product manager toolkit workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Product Manager Toolkit Review

## When To Use

Use this draft when reviewing the `product-manager-toolkit` metadata-only
...
- upstream candidate: `product-manager-toolkit`
- source domain: `product-team`
- source path: `product-team/skills/product-manager-toolkit`
