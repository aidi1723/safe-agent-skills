---
name: code-senior-fullstack-review
description: Use when reviewing senior fullstack workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-fullstack` metadata-only
...
- upstream candidate: `senior-fullstack`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-fullstack`
