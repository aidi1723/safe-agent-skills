---
name: content-marketing-demand-acquisition-review
description: Use when reviewing marketing demand acquisition workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Marketing Demand Acquisition Review

## When To Use

Use this draft when reviewing the `marketing-demand-acquisition` metadata-only
...
- upstream candidate: `marketing-demand-acquisition`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-demand-acquisition`
