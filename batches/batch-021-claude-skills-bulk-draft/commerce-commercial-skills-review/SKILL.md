---
name: commerce-commercial-skills-review
description: Use when reviewing commercial skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Commercial Skills Review

## When To Use

Use this draft when reviewing the `commercial-skills` metadata-only
...
- upstream candidate: `commercial-skills`
- source domain: `commercial`
- source path: `commercial/skills/commercial-skills`
- mapped category: `commerce`
- score: `104`
- priority: `P0`
