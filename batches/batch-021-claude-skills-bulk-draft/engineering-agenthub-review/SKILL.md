---
name: engineering-agenthub-review
description: Use when reviewing agenthub workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `agenthub` metadata-only
...
- upstream candidate: `agenthub`
- source domain: `engineering`
- source path: `engineering/agenthub/skills/agenthub`
