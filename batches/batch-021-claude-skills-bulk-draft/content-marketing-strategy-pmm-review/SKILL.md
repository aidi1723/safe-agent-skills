---
name: content-marketing-strategy-pmm-review
description: Use when reviewing marketing strategy pmm workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Marketing Strategy Pmm Review

## When To Use

Use this draft when reviewing the `marketing-strategy-pmm` metadata-only
...
- upstream candidate: `marketing-strategy-pmm`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-strategy-pmm`
