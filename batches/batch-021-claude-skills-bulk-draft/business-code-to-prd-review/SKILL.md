---
name: business-code-to-prd-review
description: Use when reviewing code to prd workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `code-to-prd` metadata-only
...
- upstream candidate: `code-to-prd`
- source domain: `product-team`
- source path: `product-team/code-to-prd/skills/code-to-prd`
