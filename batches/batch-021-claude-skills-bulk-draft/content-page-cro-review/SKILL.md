---
name: content-page-cro-review
description: Use when reviewing page cro workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `page-cro` metadata-only
...
- upstream candidate: `page-cro`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/page-cro`
