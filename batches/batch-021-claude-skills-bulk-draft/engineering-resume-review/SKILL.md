---
name: engineering-resume-review
description: Use when reviewing resume workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `resume` metadata-only
...
- upstream candidate: `resume`
- source domain: `engineering`
- source path: `engineering/autoresearch-agent/skills/resume`
