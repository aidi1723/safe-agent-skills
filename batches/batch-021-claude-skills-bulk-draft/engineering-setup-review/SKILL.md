---
name: engineering-setup-review
description: Use when reviewing setup workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `setup` metadata-only
...
- upstream candidate: `setup`
- source domain: `engineering`
- source path: `engineering/autoresearch-agent/skills/setup`
