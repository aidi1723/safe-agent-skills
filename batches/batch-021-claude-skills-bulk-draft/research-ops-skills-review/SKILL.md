---
name: research-ops-skills-review
description: Use when reviewing research ops skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Research Ops Skills Review

## When To Use

Use this draft when reviewing the `research-ops-skills` metadata-only
...
- upstream candidate: `research-ops-skills`
- source domain: `research-ops`
- source path: `research-ops/skills/research-ops-skills`
- mapped category: `research`
- score: `78`
- priority: `P1`
