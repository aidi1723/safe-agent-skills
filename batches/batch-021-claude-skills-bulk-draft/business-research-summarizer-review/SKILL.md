---
name: business-research-summarizer-review
description: Use when reviewing research summarizer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Research Summarizer Review

## When To Use

Use this draft when reviewing the `research-summarizer` metadata-only
...
- upstream candidate: `research-summarizer`
- source domain: `product-team`
- source path: `product-team/research-summarizer/skills/research-summarizer`
