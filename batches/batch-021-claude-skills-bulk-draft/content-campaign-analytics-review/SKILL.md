---
name: content-campaign-analytics-review
description: Use when reviewing campaign analytics workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `campaign-analytics` metadata-only
...
- upstream candidate: `campaign-analytics`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/campaign-analytics`
