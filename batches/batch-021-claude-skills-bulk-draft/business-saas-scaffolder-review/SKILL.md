---
name: business-saas-scaffolder-review
description: Use when reviewing saas scaffolder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Saas Scaffolder Review

## When To Use

Use this draft when reviewing the `saas-scaffolder` metadata-only
...
- upstream candidate: `saas-scaffolder`
- source domain: `product-team`
- source path: `product-team/skills/saas-scaffolder`
