---
name: business-product-strategist-review
description: Use when reviewing product strategist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `product-strategist` metadata-only
...
- upstream candidate: `product-strategist`
- source domain: `product-team`
- source path: `product-team/skills/product-strategist`
