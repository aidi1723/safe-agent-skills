---
name: business-pm-skills-review
description: Use when reviewing pm skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `pm-skills` metadata-only
...
- upstream candidate: `pm-skills`
- source domain: `project-management`
- source path: `project-management/skills/pm-skills`
