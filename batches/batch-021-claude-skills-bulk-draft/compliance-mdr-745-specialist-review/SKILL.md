---
name: compliance-mdr-745-specialist-review
description: Use when reviewing mdr 745 specialist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Mdr 745 Specialist Review

## When To Use

Use this draft when reviewing the `mdr-745-specialist` metadata-only
...
- upstream candidate: `mdr-745-specialist`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/mdr-745-specialist`
