---
name: engineering-observability-designer-review
description: Use when reviewing observability designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Observability Designer Review

## When To Use

Use this draft when reviewing the `observability-designer` metadata-only
...
- upstream candidate: `observability-designer`
- source domain: `engineering`
- source path: `engineering/skills/observability-designer`
