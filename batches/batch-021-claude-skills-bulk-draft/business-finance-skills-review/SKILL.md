---
name: business-finance-skills-review
description: Use when reviewing finance skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Finance Skills Review

## When To Use

Use this draft when reviewing the `finance-skills` metadata-only
...
- upstream candidate: `finance-skills`
- source domain: `finance`
- source path: `finance/skills/finance-skills`
