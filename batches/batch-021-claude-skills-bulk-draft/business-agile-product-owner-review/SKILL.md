---
name: business-agile-product-owner-review
description: Use when reviewing agile product owner workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Agile Product Owner Review

## When To Use

Use this draft when reviewing the `agile-product-owner` metadata-only
...
- upstream candidate: `agile-product-owner`
- source domain: `product-team`
- source path: `product-team/agile-product-owner/skills/agile-product-owner`
