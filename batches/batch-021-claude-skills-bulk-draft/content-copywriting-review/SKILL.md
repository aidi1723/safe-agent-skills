---
name: content-copywriting-review
description: Use when reviewing copywriting workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `copywriting` metadata-only
...
- upstream candidate: `copywriting`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/copywriting`
