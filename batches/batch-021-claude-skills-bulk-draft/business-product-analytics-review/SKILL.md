---
name: business-product-analytics-review
description: Use when reviewing product analytics workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `product-analytics` metadata-only
...
- upstream candidate: `product-analytics`
- source domain: `product-team`
- source path: `product-team/skills/product-analytics`
