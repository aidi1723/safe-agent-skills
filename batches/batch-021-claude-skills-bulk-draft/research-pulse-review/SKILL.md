---
name: research-pulse-review
description: Use when reviewing pulse workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `pulse` metadata-only
...
- upstream candidate: `pulse`
- source domain: `research`
- source path: `research/pulse/skills/pulse`
