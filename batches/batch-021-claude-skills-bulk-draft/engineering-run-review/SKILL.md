---
name: engineering-run-review
description: Use when reviewing run workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `run` metadata-only
...
- upstream candidate: `run`
- source domain: `engineering`
- source path: `engineering/autoresearch-agent/skills/run`
