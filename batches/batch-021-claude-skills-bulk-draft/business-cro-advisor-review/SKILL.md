---
name: business-cro-advisor-review
description: Use when reviewing cro advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cro-advisor` metadata-only
...
- upstream candidate: `cro-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/cro-advisor`
