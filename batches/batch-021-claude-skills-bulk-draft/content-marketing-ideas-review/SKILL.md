---
name: content-marketing-ideas-review
description: Use when reviewing marketing ideas workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Marketing Ideas Review

## When To Use

Use this draft when reviewing the `marketing-ideas` metadata-only
...
- upstream candidate: `marketing-ideas`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-ideas`
