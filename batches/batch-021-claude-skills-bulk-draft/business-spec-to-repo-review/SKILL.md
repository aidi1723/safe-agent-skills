---
name: business-spec-to-repo-review
description: Use when reviewing spec to repo workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `spec-to-repo` metadata-only
...
- upstream candidate: `spec-to-repo`
- source domain: `product-team`
- source path: `product-team/skills/spec-to-repo`
