---
name: engineering-codebase-onboarding-review
description: Use when reviewing codebase onboarding workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Codebase Onboarding Review

## When To Use

Use this draft when reviewing the `codebase-onboarding` metadata-only
...
- upstream candidate: `codebase-onboarding`
- source domain: `engineering`
- source path: `engineering/skills/codebase-onboarding`
