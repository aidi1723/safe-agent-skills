---
name: content-marketing-context-review
description: Use when reviewing marketing context workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Marketing Context Review

## When To Use

Use this draft when reviewing the `marketing-context` metadata-only
...
- upstream candidate: `marketing-context`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/marketing-context`
