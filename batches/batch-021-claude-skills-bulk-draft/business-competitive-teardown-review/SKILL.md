---
name: business-competitive-teardown-review
description: Use when reviewing competitive teardown workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Competitive Teardown Review

## When To Use

Use this draft when reviewing the `competitive-teardown` metadata-only
...
- upstream candidate: `competitive-teardown`
- source domain: `product-team`
- source path: `product-team/skills/competitive-teardown`
