---
name: business-operations-skills-review
description: Use when reviewing business operations skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Business Operations Skills Review

## When To Use

Use this draft when reviewing the `business-operations-skills` metadata-only
...
- upstream candidate: `business-operations-skills`
- source domain: `business-operations`
- source path: `business-operations/skills/business-operations-skills`
