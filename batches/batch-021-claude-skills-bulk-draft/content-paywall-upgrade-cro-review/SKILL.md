---
name: content-paywall-upgrade-cro-review
description: Use when reviewing paywall upgrade cro workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Paywall Upgrade Cro Review

## When To Use

Use this draft when reviewing the `paywall-upgrade-cro` metadata-only
...
- upstream candidate: `paywall-upgrade-cro`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/paywall-upgrade-cro`
