---
name: business-landing-page-generator-review
description: Use when reviewing landing page generator workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Landing Page Generator Review

## When To Use

Use this draft when reviewing the `landing-page-generator` metadata-only
...
- upstream candidate: `landing-page-generator`
- source domain: `product-team`
- source path: `product-team/skills/landing-page-generator`
