---
name: research-grants-review
description: Use when reviewing grants workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `grants` metadata-only
...
- upstream candidate: `grants`
- source domain: `research`
- source path: `research/grants/skills/grants`
