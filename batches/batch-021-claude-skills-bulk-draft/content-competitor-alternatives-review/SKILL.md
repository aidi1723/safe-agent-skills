---
name: content-competitor-alternatives-review
description: Use when reviewing competitor alternatives workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Competitor Alternatives Review

## When To Use

Use this draft when reviewing the `competitor-alternatives` metadata-only
...
- upstream candidate: `competitor-alternatives`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/competitor-alternatives`
