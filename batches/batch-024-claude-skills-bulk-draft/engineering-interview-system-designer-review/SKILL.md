---
name: engineering-interview-system-designer-review
description: Use when reviewing interview system designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Interview System Designer Review

## When To Use

Use this draft when reviewing the `interview-system-designer` metadata-only
...
- upstream candidate: `interview-system-designer`
- source domain: `engineering`
- source path: `engineering/skills/interview-system-designer`
