---
name: code-senior-security-review
description: Use when reviewing senior security workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-security` metadata-only
...
- upstream candidate: `senior-security`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-security`
