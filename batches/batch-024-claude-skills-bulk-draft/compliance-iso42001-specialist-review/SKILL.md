---
name: compliance-iso42001-specialist-review
description: Use when reviewing iso42001 specialist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Iso42001 Specialist Review

## When To Use

Use this draft when reviewing the `iso42001-specialist` metadata-only
...
- upstream candidate: `iso42001-specialist`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/iso42001-specialist`
