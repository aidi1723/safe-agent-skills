---
name: compliance-fda-consultant-specialist-review
description: Use when reviewing fda consultant specialist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Fda Consultant Specialist Review

## When To Use

Use this draft when reviewing the `fda-consultant-specialist` metadata-only
...
- upstream candidate: `fda-consultant-specialist`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/fda-consultant-specialist`
