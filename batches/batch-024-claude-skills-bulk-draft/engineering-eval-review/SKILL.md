---
name: engineering-eval-review
description: Use when reviewing eval workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `eval` metadata-only
...
- upstream candidate: `eval`
- source domain: `engineering`
- source path: `engineering/agenthub/skills/eval`
