---
name: engineering-sample-skill-review
description: Use when reviewing sample skill workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `sample-skill` metadata-only
...
- upstream candidate: `sample-skill`
- source domain: `engineering`
- source path: `engineering/skills/skill-tester/assets/sample-skill`
