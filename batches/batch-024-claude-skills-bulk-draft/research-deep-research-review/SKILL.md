---
name: research-deep-research-review
description: Use when reviewing deep research workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `deep-research` metadata-only
...
- upstream candidate: `deep-research`
- source domain: `research`
- source path: `research/deep-research/skills/deep-research`
