---
name: engineering-terraform-patterns-review
description: Use when reviewing terraform patterns workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Terraform Patterns Review

## When To Use

Use this draft when reviewing the `terraform-patterns` metadata-only
...
- upstream candidate: `terraform-patterns`
- source domain: `engineering`
- source path: `engineering/terraform-patterns/skills/terraform-patterns`
