---
name: engineering-workflow-builder-review
description: Use when reviewing workflow builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `workflow-builder` metadata-only
...
- upstream candidate: `workflow-builder`
- source domain: `engineering`
- source path: `engineering/workflow-builder/skills/workflow-builder`
