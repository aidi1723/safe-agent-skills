---
name: engineering-write-a-skill-review
description: Use when reviewing write a skill workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Write A Skill Review

## When To Use

Use this draft when reviewing the `write-a-skill` metadata-only
...
- upstream candidate: `write-a-skill`
- source domain: `engineering`
- source path: `engineering/write-a-skill/skills/write-a-skill`
