---
name: code-playwright-pro-review
description: Use when reviewing playwright pro workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `playwright-pro` metadata-only
...
- upstream candidate: `playwright-pro`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/pw`
