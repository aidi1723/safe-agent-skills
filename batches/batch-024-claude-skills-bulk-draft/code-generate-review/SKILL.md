...
description: Use when reviewing generate workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `generate` metadata-only
...
- upstream candidate: `generate`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/generate`
