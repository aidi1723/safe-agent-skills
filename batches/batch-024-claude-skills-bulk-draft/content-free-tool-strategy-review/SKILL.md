---
name: content-free-tool-strategy-review
description: Use when reviewing free tool strategy workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Free Tool Strategy Review

## When To Use

Use this draft when reviewing the `free-tool-strategy` metadata-only
...
- upstream candidate: `free-tool-strategy`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/free-tool-strategy`
