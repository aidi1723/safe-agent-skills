---
name: code-email-template-builder-review
description: Use when reviewing email template builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `email-template-builder` metadata-only
...
- upstream candidate: `email-template-builder`
- source domain: `engineering-team`
- source path: `engineering-team/skills/email-template-builder`
