---
name: engineering-tech-debt-tracker-review
description: Use when reviewing tech debt tracker workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Tech Debt Tracker Review

## When To Use

Use this draft when reviewing the `tech-debt-tracker` metadata-only
...
- upstream candidate: `tech-debt-tracker`
- source domain: `engineering`
- source path: `engineering/skills/tech-debt-tracker`
