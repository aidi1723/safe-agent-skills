---
name: engineering-performance-profiler-review
description: Use when reviewing performance profiler workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Performance Profiler Review

## When To Use

Use this draft when reviewing the `performance-profiler` metadata-only
...
- upstream candidate: `performance-profiler`
- source domain: `engineering`
- source path: `engineering/skills/performance-profiler`
