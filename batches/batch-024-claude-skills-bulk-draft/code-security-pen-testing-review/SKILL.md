---
name: code-security-pen-testing-review
description: Use when reviewing security pen testing workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Security Pen Testing Review

## When To Use

Use this draft when reviewing the `security-pen-testing` metadata-only
...
- upstream candidate: `security-pen-testing`
- source domain: `engineering-team`
- source path: `engineering-team/skills/security-pen-testing`
