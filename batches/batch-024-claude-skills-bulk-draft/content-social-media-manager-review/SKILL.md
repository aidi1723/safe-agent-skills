---
name: content-social-media-manager-review
description: Use when reviewing social media manager workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `social-media-manager` metadata-only
...
- upstream candidate: `social-media-manager`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/social-media-manager`
