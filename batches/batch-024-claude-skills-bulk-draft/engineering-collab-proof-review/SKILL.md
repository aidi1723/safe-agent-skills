---
name: engineering-collab-proof-review
description: Use when reviewing collab proof workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `collab-proof` metadata-only
...
- upstream candidate: `collab-proof`
- source domain: `engineering`
- source path: `engineering/collab-proof/skills/collab-proof`
