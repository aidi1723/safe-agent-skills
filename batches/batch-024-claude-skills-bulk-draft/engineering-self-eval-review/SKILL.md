---
name: engineering-self-eval-review
description: Use when reviewing self eval workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `self-eval` metadata-only
...
- upstream candidate: `self-eval`
- source domain: `engineering`
- source path: `engineering/skills/self-eval`
