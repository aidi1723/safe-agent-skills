---
name: content-social-content-review
description: Use when reviewing social content workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `social-content` metadata-only
...
- upstream candidate: `social-content`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/social-content`
