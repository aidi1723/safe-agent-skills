...
description: Use when reviewing code reviewer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `code-reviewer` metadata-only
...
- upstream candidate: `code-reviewer`
- source domain: `engineering-team`
- source path: `engineering-team/skills/code-reviewer`
