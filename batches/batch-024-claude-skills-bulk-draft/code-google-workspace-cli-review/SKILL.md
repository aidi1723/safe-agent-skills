---
name: code-google-workspace-cli-review
description: Use when reviewing google workspace cli workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Google Workspace Cli Review

## When To Use

Use this draft when reviewing the `google-workspace-cli` metadata-only
...
- upstream candidate: `google-workspace-cli`
- source domain: `engineering-team`
- source path: `engineering-team/google-workspace-cli/skills/google-workspace-cli`
