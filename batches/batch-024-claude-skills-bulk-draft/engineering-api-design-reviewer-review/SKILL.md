---
name: engineering-api-design-reviewer-review
description: Use when reviewing api design reviewer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Api Design Reviewer Review

## When To Use

Use this draft when reviewing the `api-design-reviewer` metadata-only
...
- upstream candidate: `api-design-reviewer`
- source domain: `engineering`
- source path: `engineering/skills/api-design-reviewer`
