---
name: engineering-ship-gate-review
description: Use when reviewing ship gate workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ship-gate` metadata-only
...
- upstream candidate: `ship-gate`
- source domain: `engineering`
- source path: `engineering/skills/ship-gate`
