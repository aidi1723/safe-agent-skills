---
name: engineering-prompt-governance-review
description: Use when reviewing prompt governance workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `prompt-governance` metadata-only
...
- upstream candidate: `prompt-governance`
- source domain: `engineering`
- source path: `engineering/prompt-governance/skills/prompt-governance`
