---
name: research-research-review
description: Use when reviewing research workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `research` metadata-only
...
- source path: `research/research/skills/research`
