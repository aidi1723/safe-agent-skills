---
name: engineering-demo-video-review
description: Use when reviewing demo video workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `demo-video` metadata-only
...
- upstream candidate: `demo-video`
- source domain: `engineering`
- source path: `engineering/demo-video/skills/demo-video`
