---
name: code-senior-data-scientist-review
description: Use when reviewing senior data scientist workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `senior-data-scientist` metadata-only
...
- upstream candidate: `senior-data-scientist`
- source domain: `engineering-team`
- source path: `engineering-team/skills/senior-data-scientist`
