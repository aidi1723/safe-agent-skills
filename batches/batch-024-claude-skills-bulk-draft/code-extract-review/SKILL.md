---
name: code-extract-review
description: Use when reviewing extract workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `extract` metadata-only
...
- upstream candidate: `extract`
- source domain: `engineering-team`
- source path: `engineering-team/self-improving-agent/skills/extract`
