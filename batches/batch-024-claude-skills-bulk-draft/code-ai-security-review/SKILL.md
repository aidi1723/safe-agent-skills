---
name: code-ai-security-review
description: Use when reviewing ai security workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ai-security` metadata-only
...
- upstream candidate: `ai-security`
- source domain: `engineering-team`
- source path: `engineering-team/skills/ai-security`
