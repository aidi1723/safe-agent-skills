---
name: engineering-board-review
description: Use when reviewing board workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `board` metadata-only
...
- upstream candidate: `board`
- source domain: `engineering`
- source path: `engineering/agenthub/skills/board`
