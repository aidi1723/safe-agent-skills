---
name: engineering-pr-review-expert-review
description: Use when reviewing pr review expert workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Pr Review Expert Review

## When To Use

Use this draft when reviewing the `pr-review-expert` metadata-only
...
- upstream candidate: `pr-review-expert`
- source domain: `engineering`
- source path: `engineering/skills/pr-review-expert`
