---
name: engineering-full-page-screenshot-review
description: Use when reviewing full page screenshot workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `full-page-screenshot` metadata-only
...
- upstream candidate: `full-page-screenshot`
- source domain: `engineering`
- source path: `engineering/skills/full-page-screenshot`
