---
name: code-report-review
description: Use when reviewing report workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `report` metadata-only
...
- upstream candidate: `report`
- source domain: `engineering-team`
- source path: `engineering-team/playwright-pro/skills/report`
