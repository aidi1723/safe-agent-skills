---
name: content-prompt-engineer-toolkit-review
description: Use when reviewing prompt engineer toolkit workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Prompt Engineer Toolkit Review

## When To Use

Use this draft when reviewing the `prompt-engineer-toolkit` metadata-only
...
- upstream candidate: `prompt-engineer-toolkit`
- source domain: `marketing-skill`
- source path: `marketing-skill/skills/prompt-engineer-toolkit`
