---
name: engineering-database-schema-designer-review
description: Use when reviewing database schema designer workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Database Schema Designer Review

## When To Use

Use this draft when reviewing the `database-schema-designer` metadata-only
...
- upstream candidate: `database-schema-designer`
- source domain: `engineering`
- source path: `engineering/skills/database-schema-designer`
