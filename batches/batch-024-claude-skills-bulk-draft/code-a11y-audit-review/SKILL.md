---
name: code-a11y-audit-review
description: Use when reviewing a11y audit workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `a11y-audit` metadata-only
...
- upstream candidate: `a11y-audit`
- source domain: `engineering-team`
- source path: `engineering-team/a11y-audit/skills/a11y-audit`
