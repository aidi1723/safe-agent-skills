---
name: code-cloud-security-review
description: Use when reviewing cloud security workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cloud-security` metadata-only
...
- upstream candidate: `cloud-security`
- source domain: `engineering-team`
- source path: `engineering-team/skills/cloud-security`
