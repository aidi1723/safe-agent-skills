---
name: compliance-gdpr-dsgvo-expert-review
description: Use when reviewing gdpr dsgvo expert workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Gdpr Dsgvo Expert Review

## When To Use

Use this draft when reviewing the `gdpr-dsgvo-expert` metadata-only
...
- upstream candidate: `gdpr-dsgvo-expert`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/gdpr-dsgvo-expert`
