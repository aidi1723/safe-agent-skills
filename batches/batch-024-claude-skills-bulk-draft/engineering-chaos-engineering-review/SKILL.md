---
name: engineering-chaos-engineering-review
description: Use when reviewing chaos engineering workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `chaos-engineering` metadata-only
...
- upstream candidate: `chaos-engineering`
- source domain: `engineering`
- source path: `engineering/skills/chaos-engineering`
