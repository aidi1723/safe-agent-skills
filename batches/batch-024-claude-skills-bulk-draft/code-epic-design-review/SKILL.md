---
name: code-epic-design-review
description: Use when reviewing epic design workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `epic-design` metadata-only
...
- upstream candidate: `epic-design`
- source domain: `engineering-team`
- source path: `engineering-team/skills/epic-design`
