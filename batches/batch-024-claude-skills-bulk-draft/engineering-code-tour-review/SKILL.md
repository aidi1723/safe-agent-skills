---
name: engineering-code-tour-review
description: Use when reviewing code tour workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `code-tour` metadata-only
...
- upstream candidate: `code-tour`
- source domain: `engineering`
- source path: `engineering/code-tour/skills/code-tour`
