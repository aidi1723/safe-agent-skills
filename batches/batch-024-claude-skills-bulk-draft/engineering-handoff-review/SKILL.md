---
name: engineering-handoff-review
description: Use when reviewing handoff workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `handoff` metadata-only
...
- upstream candidate: `handoff`
- source domain: `engineering`
- source path: `engineering/handoff/skills/handoff`
