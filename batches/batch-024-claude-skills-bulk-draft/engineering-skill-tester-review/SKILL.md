---
name: engineering-skill-tester-review
description: Use when reviewing skill tester workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `skill-tester` metadata-only
...
- upstream candidate: `skill-tester`
- source domain: `engineering`
- source path: `engineering/skills/skill-tester`
