---
name: engineering-sql-database-assistant-review
description: Use when reviewing sql database assistant workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Sql Database Assistant Review

## When To Use

Use this draft when reviewing the `sql-database-assistant` metadata-only
...
- upstream candidate: `sql-database-assistant`
- source domain: `engineering`
- source path: `engineering/skills/sql-database-assistant`
