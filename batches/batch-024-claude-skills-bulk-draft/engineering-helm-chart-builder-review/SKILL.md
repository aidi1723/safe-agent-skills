---
name: engineering-helm-chart-builder-review
description: Use when reviewing helm chart builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Helm Chart Builder Review

## When To Use

Use this draft when reviewing the `helm-chart-builder` metadata-only
...
- upstream candidate: `helm-chart-builder`
- source domain: `engineering`
- source path: `engineering/helm-chart-builder/skills/helm-chart-builder`
