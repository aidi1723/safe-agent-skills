---
name: business-intl-expansion-review
description: Use when reviewing intl expansion workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Intl Expansion Review

## When To Use

Use this draft when reviewing the `intl-expansion` metadata-only
...
- upstream candidate: `intl-expansion`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/intl-expansion`
