---
name: business-coo-advisor-review
description: Use when reviewing coo advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `coo-advisor` metadata-only
...
- upstream candidate: `coo-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/coo-advisor`
