---
name: business-chief-customer-officer-advisor-review
description: Use when reviewing chief customer officer advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Chief Customer Officer Advisor Review

## When To Use

Use this draft when reviewing the `chief-customer-officer-advisor` metadata-only
...
- upstream candidate: `chief-customer-officer-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/chief-customer-officer-advisor`
