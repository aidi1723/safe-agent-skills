---
name: business-chro-advisor-review
description: Use when reviewing chro advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `chro-advisor` metadata-only
...
- upstream candidate: `chro-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/chro-advisor`
