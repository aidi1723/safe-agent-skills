---
name: business-cdo-review-review
description: Use when reviewing cdo review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cdo-review` metadata-only
...
- upstream candidate: `cdo-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cdo-review`
