---
name: business-postmortem-review
description: Use when reviewing postmortem workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `postmortem` metadata-only
...
- upstream candidate: `postmortem`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/executive-mentor/skills/postmortem`
