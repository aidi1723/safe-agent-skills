---
name: business-chief-ai-officer-advisor-review
description: Use when reviewing chief ai officer advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Chief Ai Officer Advisor Review

## When To Use

Use this draft when reviewing the `chief-ai-officer-advisor` metadata-only
...
- upstream candidate: `chief-ai-officer-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/chief-ai-officer-advisor`
