---
name: business-cco-review-review
description: Use when reviewing cco review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cco-review` metadata-only
...
- upstream candidate: `cco-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cco-review`
