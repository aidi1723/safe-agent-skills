---
name: business-onboard-review
description: Use when reviewing onboard workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `onboard` metadata-only
...
- upstream candidate: `onboard`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/onboard`
