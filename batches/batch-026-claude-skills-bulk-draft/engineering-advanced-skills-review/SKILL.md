---
name: engineering-advanced-skills-review
description: Use when reviewing engineering advanced skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Engineering Advanced Skills Review

## When To Use

Use this draft when reviewing the `engineering-advanced-skills` metadata-only
...
- upstream candidate: `engineering-advanced-skills`
- source domain: `engineering`
- source path: `engineering/skills/engineering-advanced-skills`
