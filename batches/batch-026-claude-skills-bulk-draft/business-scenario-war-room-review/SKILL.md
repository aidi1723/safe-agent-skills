---
name: business-scenario-war-room-review
description: Use when reviewing scenario war room workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Scenario War Room Review

## When To Use

Use this draft when reviewing the `scenario-war-room` metadata-only
...
- upstream candidate: `scenario-war-room`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/scenario-war-room`
