---
name: business-c-level-agents-review
description: Use when reviewing c level agents workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# C Level Agents Review

## When To Use

Use this draft when reviewing the `c-level-agents` metadata-only
...
- upstream candidate: `c-level-agents`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/c-level-agents`
