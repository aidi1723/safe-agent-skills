---
name: business-decide-review
description: Use when reviewing decide workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `decide` metadata-only
...
- upstream candidate: `decide`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/decide`
