---
name: business-ceo-advisor-review
description: Use when reviewing ceo advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ceo-advisor` metadata-only
...
- upstream candidate: `ceo-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/ceo-advisor`
