---
name: business-stress-test-review
description: Use when reviewing stress test workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `stress-test` metadata-only
...
- upstream candidate: `stress-test`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/executive-mentor/skills/stress-test`
