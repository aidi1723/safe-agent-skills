---
name: business-org-health-diagnostic-review
description: Use when reviewing org health diagnostic workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Org Health Diagnostic Review

## When To Use

Use this draft when reviewing the `org-health-diagnostic` metadata-only
...
- upstream candidate: `org-health-diagnostic`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/org-health-diagnostic`
