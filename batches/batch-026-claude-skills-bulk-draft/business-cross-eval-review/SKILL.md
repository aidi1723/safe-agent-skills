---
name: business-cross-eval-review
description: Use when reviewing cross eval workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cross-eval` metadata-only
...
- upstream candidate: `cross-eval`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cross-eval`
