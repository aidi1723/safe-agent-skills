---
name: business-challenge-review
description: Use when reviewing challenge workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `challenge` metadata-only
...
- upstream candidate: `challenge`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/executive-mentor/skills/challenge`
