---
name: business-agent-protocol-review
description: Use when reviewing agent protocol workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `agent-protocol` metadata-only
...
- upstream candidate: `agent-protocol`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/agent-protocol`
