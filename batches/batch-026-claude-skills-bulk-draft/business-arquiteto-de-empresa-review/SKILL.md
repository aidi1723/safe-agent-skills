---
name: business-arquiteto-de-empresa-review
description: Use when reviewing arquiteto de empresa workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Arquiteto De Empresa Review

## When To Use

Use this draft when reviewing the `arquiteto-de-empresa` metadata-only
...
- upstream candidate: `arquiteto-de-empresa`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/arquiteto-de-empresa`
