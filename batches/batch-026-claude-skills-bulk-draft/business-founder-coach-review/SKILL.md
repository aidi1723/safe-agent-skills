---
name: business-founder-coach-review
description: Use when reviewing founder coach workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Founder Coach Review

## When To Use

Use this draft when reviewing the `founder-coach` metadata-only
...
- upstream candidate: `founder-coach`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/founder-coach`
