---
name: business-gc-review-review
description: Use when reviewing gc review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `gc-review` metadata-only
...
- upstream candidate: `gc-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/gc-review`
