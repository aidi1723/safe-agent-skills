---
name: business-cto-review-review
description: Use when reviewing cto review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cto-review` metadata-only
...
- upstream candidate: `cto-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cto-review`
