---
name: business-execute-review
description: Use when reviewing execute workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `execute` metadata-only
...
- upstream candidate: `execute`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/execute`
