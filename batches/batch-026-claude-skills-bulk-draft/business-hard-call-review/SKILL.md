---
name: business-hard-call-review
description: Use when reviewing hard call workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `hard-call` metadata-only
...
- upstream candidate: `hard-call`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/executive-mentor/skills/hard-call`
