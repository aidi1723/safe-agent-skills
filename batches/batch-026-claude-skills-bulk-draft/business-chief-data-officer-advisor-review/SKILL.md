---
name: business-chief-data-officer-advisor-review
description: Use when reviewing chief data officer advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Chief Data Officer Advisor Review

## When To Use

Use this draft when reviewing the `chief-data-officer-advisor` metadata-only
...
- upstream candidate: `chief-data-officer-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/chief-data-officer-advisor`
