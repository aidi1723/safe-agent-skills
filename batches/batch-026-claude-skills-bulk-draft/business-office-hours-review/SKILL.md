---
name: business-office-hours-review
description: Use when reviewing office hours workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `office-hours` metadata-only
...
- upstream candidate: `office-hours`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/office-hours`
