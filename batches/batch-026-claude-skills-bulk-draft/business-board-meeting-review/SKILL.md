---
name: business-board-meeting-review
description: Use when reviewing board meeting workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `board-meeting` metadata-only
...
- upstream candidate: `board-meeting`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/board-meeting`
