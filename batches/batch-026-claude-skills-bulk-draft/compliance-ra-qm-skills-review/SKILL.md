---
name: compliance-ra-qm-skills-review
description: Use when reviewing ra qm skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ra-qm-skills` metadata-only
...
- upstream candidate: `ra-qm-skills`
- source domain: `ra-qm-team`
- source path: `ra-qm-team/skills/ra-qm-skills`
