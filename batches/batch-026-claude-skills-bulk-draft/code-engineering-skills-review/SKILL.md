---
name: code-engineering-skills-review
description: Use when reviewing engineering skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `engineering-skills` metadata-only
...
- upstream candidate: `engineering-skills`
- source domain: `engineering-team`
- source path: `engineering-team/skills/engineering-skills`
