---
name: business-vpe-review-review
description: Use when reviewing vpe review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `vpe-review` metadata-only
...
- upstream candidate: `vpe-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/vpe-review`
