---
name: business-cmo-review-review
description: Use when reviewing cmo review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cmo-review` metadata-only
...
- upstream candidate: `cmo-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cmo-review`
