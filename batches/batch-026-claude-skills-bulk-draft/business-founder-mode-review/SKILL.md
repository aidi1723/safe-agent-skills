---
name: business-founder-mode-review
description: Use when reviewing founder mode workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `founder-mode` metadata-only
...
- upstream candidate: `founder-mode`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/founder-mode`
