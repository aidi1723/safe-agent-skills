---
name: business-change-management-review
description: Use when reviewing change management workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `change-management` metadata-only
...
- upstream candidate: `change-management`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/change-management`
