---
name: business-executive-mentor-review
description: Use when reviewing executive mentor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Executive Mentor Review

## When To Use

Use this draft when reviewing the `executive-mentor` metadata-only
...
- upstream candidate: `executive-mentor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/executive-mentor/skills/executive-mentor`
