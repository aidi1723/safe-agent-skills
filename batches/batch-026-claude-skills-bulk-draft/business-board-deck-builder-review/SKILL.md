---
name: business-board-deck-builder-review
description: Use when reviewing board deck builder workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Board Deck Builder Review

## When To Use

Use this draft when reviewing the `board-deck-builder` metadata-only
...
- upstream candidate: `board-deck-builder`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/board-deck-builder`
