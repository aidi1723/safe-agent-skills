---
name: business-cfo-review-review
description: Use when reviewing cfo review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cfo-review` metadata-only
...
- upstream candidate: `cfo-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cfo-review`
