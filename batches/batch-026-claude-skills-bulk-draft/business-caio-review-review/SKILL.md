---
name: business-caio-review-review
description: Use when reviewing caio review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `caio-review` metadata-only
...
- upstream candidate: `caio-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/caio-review`
