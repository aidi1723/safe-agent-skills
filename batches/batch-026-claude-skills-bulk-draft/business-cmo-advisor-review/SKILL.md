---
name: business-cmo-advisor-review
description: Use when reviewing cmo advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cmo-advisor` metadata-only
...
- upstream candidate: `cmo-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/cmo-advisor`
