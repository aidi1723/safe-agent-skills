---
name: business-strategic-alignment-review
description: Use when reviewing strategic alignment workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `strategic-alignment` metadata-only
...
- upstream candidate: `strategic-alignment`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/strategic-alignment`
