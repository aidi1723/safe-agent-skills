---
name: business-chief-of-staff-review
description: Use when reviewing chief of staff workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `chief-of-staff` metadata-only
...
- upstream candidate: `chief-of-staff`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/chief-of-staff`
