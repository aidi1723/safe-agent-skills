---
name: business-company-os-review
description: Use when reviewing company os workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `company-os` metadata-only
...
- upstream candidate: `company-os`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/company-os`
