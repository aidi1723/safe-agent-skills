---
name: business-cpo-advisor-review
description: Use when reviewing cpo advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cpo-advisor` metadata-only
...
- upstream candidate: `cpo-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/cpo-advisor`
