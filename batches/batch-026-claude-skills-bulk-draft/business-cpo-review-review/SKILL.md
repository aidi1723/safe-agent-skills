---
name: business-cpo-review-review
description: Use when reviewing cpo review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cpo-review` metadata-only
...
- upstream candidate: `cpo-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/cpo-review`
