---
name: business-cfo-advisor-review
description: Use when reviewing cfo advisor workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cfo-advisor` metadata-only
...
- upstream candidate: `cfo-advisor`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/cfo-advisor`
