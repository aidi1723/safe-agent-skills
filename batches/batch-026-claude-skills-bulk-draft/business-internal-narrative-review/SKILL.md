---
name: business-internal-narrative-review
description: Use when reviewing internal narrative workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Internal Narrative Review

## When To Use

Use this draft when reviewing the `internal-narrative` metadata-only
...
- upstream candidate: `internal-narrative`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/internal-narrative`
