---
name: business-decision-logger-review
description: Use when reviewing decision logger workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Decision Logger Review

## When To Use

Use this draft when reviewing the `decision-logger` metadata-only
...
- upstream candidate: `decision-logger`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/decision-logger`
