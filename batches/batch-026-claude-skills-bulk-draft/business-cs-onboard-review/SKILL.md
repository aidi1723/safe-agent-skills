---
name: business-cs-onboard-review
description: Use when reviewing cs onboard workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `cs-onboard` metadata-only
...
- upstream candidate: `cs-onboard`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/cs-onboard`
