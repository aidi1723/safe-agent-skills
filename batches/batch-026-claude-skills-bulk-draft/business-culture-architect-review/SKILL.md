---
name: business-culture-architect-review
description: Use when reviewing culture architect workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# Culture Architect Review

## When To Use

Use this draft when reviewing the `culture-architect` metadata-only
...
- upstream candidate: `culture-architect`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/culture-architect`
