---
name: business-ciso-review-review
description: Use when reviewing ciso review workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `ciso-review` metadata-only
...
- upstream candidate: `ciso-review`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/c-level-agents/skills/ciso-review`
