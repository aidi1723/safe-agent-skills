...
5. Keep credentials and provider secrets outside skill instructions.
6. Verify that logs do not expose private prompts, user data, or credentials.
...
patterns and does not bundle proxy code, provider connectors, or credentials.
