---
name: business-c-level-skills-review
description: Use when reviewing c level skills workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---

# C Level Skills Review

## When To Use

Use this draft when reviewing the `c-level-skills` metadata-only
...
- upstream candidate: `c-level-skills`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/c-level-skills`
