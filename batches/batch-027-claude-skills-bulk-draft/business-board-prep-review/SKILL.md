---
name: business-board-prep-review
description: Use when reviewing board prep workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `board-prep` metadata-only
...
- upstream candidate: `board-prep`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/executive-mentor/skills/board-prep`
