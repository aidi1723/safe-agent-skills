---
name: business-context-engine-review
description: Use when reviewing context engine workflows, metadata-only skill candidates, upstream reference clusters, or local adoption drafts before catalog inclusion.
---
...
Use this draft when reviewing the `context-engine` metadata-only
...
- upstream candidate: `context-engine`
- source domain: `c-level-advisor`
- source path: `c-level-advisor/skills/context-engine`
